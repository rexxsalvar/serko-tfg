...
@section('content')
    <section class="space-y-6">
        <div class="serko-card overflow-hidden">
            @php($stadiumImage = $stadium->image ? (filter_var($stadium->image, FILTER_VALIDATE_URL) ? $stadium->image : asset('storage/'.$stadium->image)) : 'https://placehold.co/1200x500?text=SERKO+Stadium')
